		...
		<div class="bg-blue ">
			<div class="container">
				<div class="line-login line">
					...
					<div class="x5">
						<div class="login-x5">
							<form method="post" class="form-inline" action="${pageContext.request.contextPath}/manager/admin_adminLogin.action">
								<div class="form-group">
									...
									<div class="field">
										<div class="input-group">
											<input type="submit" id="tj" class="button bg-yellow button-small button-block" value="登录"/>
										</div>
									</div>
									<div class="line">
										<div class="x6">
